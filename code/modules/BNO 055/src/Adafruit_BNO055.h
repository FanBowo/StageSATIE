 ...
 *          BNO055 Sensor
 */
class Adafruit_BNO055 : public Adafruit_Sensor,public I2Cdev{
public:
  /** BNO055 Registers **/
  typedef enum {
...
private:
  //those three functions read8, readLen and write8 need to be replaced depend on the specifique plateform
