...
#include "I2Cdev.h"
#include "LinuxClk.h"
#define i2c_write(a, b, c, d) LinuxWriteBytes(a, b, c, d)
#define i2c_read(a, b, c, d)  LinuxReadBytes(a, b, c, d)
#define delay_ms(a)  Linux_delay_ms(a)
#define get_ms(a)   Linux_get_clock_ms(a)
#define log_i     printf
#define log_e     printf
