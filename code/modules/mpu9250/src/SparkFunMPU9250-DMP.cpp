...
unsigned short MPU9250_DMP::constrain(unsigned short input_var, unsigned short min_val, unsigned short max_val){

 return ((input_var>max_val)?max_val:(input_var<min_val?min_val:input_var));
}
